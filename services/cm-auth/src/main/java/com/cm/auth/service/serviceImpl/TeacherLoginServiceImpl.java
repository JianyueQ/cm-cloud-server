...
import com.cm.auth.mapper.TeacherLoginMapper;
...
public class TeacherLoginServiceImpl implements TeacherLoginService {
    ...
    private final TeacherLoginMapper teacherLoginMapper;
    private final JwtProperties jwtProperties;
    private final RedisTemplate<String, String> redisTemplate;
    private final VerifyCodeService verifyCodeService;

    public TeacherLoginServiceImpl(TeacherLoginMapper teacherLoginMapper, JwtProperties jwtProperties, RedisTemplate<String, String> redisTemplate, VerifyCodeService verifyCodeService) {
        this.teacherLoginMapper = teacherLoginMapper;
