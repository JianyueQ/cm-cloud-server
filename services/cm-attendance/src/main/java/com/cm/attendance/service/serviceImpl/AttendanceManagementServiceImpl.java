package com.cm.attendance.service.serviceImpl;
...
import com.cm.common.core.manager.AsyncManager;
...
public class AttendanceManagementServiceImpl implements AttendanceManagementService {
    ...
    public AttendanceManagementServiceImpl(RabbitTemplate rabbitTemplate, AttendanceManagementMapper attendanceManagementMapper, RedisTemplate<String, String> redisTemplate) {
