...
import com.cm.common.core.constant.TypeConstant;
...
import com.cm.common.core.utils.ParametersUtil;
import com.cm.common.core.utils.UUIDUtils;
import com.cm.common.enumeration.OperationType;
import com.cm.dto.*;
import com.cm.entity.Admin;
import com.cm.entity.User;
import com.cm.user.mapper.AdminUserInfoMapper;
import com.cm.user.service.AdminUserInfoService;
...
public class AdminUserInfoServiceImpl implements AdminUserInfoService {
    ...
    private final AdminUserInfoMapper adminUserInfoMapper;
    private final RedisTemplate<String, String> redisTemplate;
    private static final String TRUE = "true";

    public AdminUserInfoServiceImpl(AdminUserInfoMapper adminUserInfoMapper, RedisTemplate<String, String> redisTemplate) {
    ...
    public void addUser(AdminUserInfoDTO adminUserInfoDTO) {
        ...
        //查询用户名是否重复
        User repeat = adminUserInfoMapper.getAdminByUsername(adminUserInfoDTO.getUsername());
        if (repeat != null) {
